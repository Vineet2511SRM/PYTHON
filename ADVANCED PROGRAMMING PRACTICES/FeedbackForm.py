...
def submit_feedback():
    ...
    if not feedback:
        messagebox.showwarning("Empty", "Please enter your feedback before submitting.") ; return
    if not rating:
        messagebox.showwarning("Rating", "Please select a rating before submitting.") ; return
    ...
    for v in feedback_types.values():
        v.set(0)
root = tk.Tk()
root.title("Feedback Form"); root.geometry("420x480") ; root.geometry("420x480")
